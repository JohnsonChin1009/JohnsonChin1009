...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Johnson's Portfolio</title>
        ...
        <section>
          <div className=" dark:text-white">
            ...
            <p className="text-md py-2 leading-8 text-gray-800  dark:text-white">
              I'm Johnson, a student from Asia Pacific University. The reason I want to become a full-stack developer is because I want to help more and more communities to join in the digital era. I'm also volunteering in NGOs such as St. John Ambulans Malaysia, actively joining in public duties and managing a school of members.
            </p>
          </div>
